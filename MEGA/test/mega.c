 ...
 * For: ATMEGA328P
 */ 
#define KEY_PRT PORTK	//WRITE
#define KEY_DDR	DDRK	//DIRECTION
#define KEY_PIN PINK	//READ
...
int main(void)
{
    ...
    PORTB = 0b01000000; // PIR enable only first pin
    DDRD = 0b00000000; // PIR outputs
    ...
    while (1) 
    {
		...
		//if(armed) PORTB |= _BV(PB5); should go to uno
